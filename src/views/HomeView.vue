      ...
      <div class="relative flex justify-center items-center flex-col w-[80%] md:w-[70%] lg:w-[50%] m-auto pt-[50px] sm:pt-[100px]">
        ...
        <div>
          <p class="mb-10 lg:text-lg lg:leading-7">
            ...
            talents and enthusiasts, startups, and organizations in the Nigerian Construction Industry. This event(movement) serves as a catalyst for leveraging technological advancements and opportunities within Nigeria's AEC industry.
          </p>
          <p class="mb-10 lg:text-lg lg:leading-7">
            <span class="font-700 text-xl">Our mission</span> is to awaken technological innovation, bridge the investment
            opportunities gap, inspire tech talents and startups within the industry and empower the industry with the necessary resources and roadmaps to achieve sustainable technology development goals.
          </p>
          <p class="mb-10 lg:text-lg lg:leading-7">
            This inaugural event brings together innovative minds, industry experts and ConTech enthusiasts to explore the exciting potential of local tech solutions in shaping the future of the built environment.
          </p>
      ...
      <div class=" m-auto w-[80vw] p-3 md:p-6 lg:p-12">
        ...
        <div class="grid grids-col-1 sm:grid-cols-2 lg:grid-cols-4 gap-20">
          ...
          <div class="w-full relative">
            ...
            <div class="bg-secondary p-5 text-center rounded-b-lg absolute bottom-0 w-full h-[9vh]">Brainstorming sessions</div>
          </div>
          <div class="w-full relative">
